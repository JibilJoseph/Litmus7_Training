...
public class EmployeeController {
    ...
    public Response<Integer> writeDataToDB(String filepath) throws IOException
    {
 ...
 // controller function 2 : Get All Employee Details
	...
	public Response<List<Employee>> getAllEmployees() {
		...
		if(employees==null)
		{
			logger.severe("Failed to fetch employee data from database");
			return new Response<>(500,"Failed to Fetch Employee Data");
		}
		
		logger.info("Successfully fetched " + employees.size() + " employee records");
		return new Response<>(200,"Employee Data Fetch Success",employees);
	}
}
