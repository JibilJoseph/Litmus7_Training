...
public class Validator {
    ...
    public static Response validateFirstName(String value) {
        ...
        return new Response(1, 0); // code 1 for success, value not used
    }
    ...
    public static Response validateEmail(String value) {
        ...
        if (!EMAIL_PATTERN.matcher(email).matches()) return new Response(2, "Invalid email format");
        return new Response(1, 0);
    }

    public static Response validatePhone(String value) {
        String phone = value.trim();
        if (!PHONE_PATTERN.matcher(phone).matches()) return new Response(2, "Invalid phone number");
        return new Response(1, 0);
    }
    ...
    public static Response validateSalary(String value) {
        try {
            ...
            return new Response(1, (int)salary); // returns int part of salary
        } catch (NumberFormatException e) {
