...
public class InventoryService {
    ...
    public InventoryService() {
        ...
        Applogger.setupLogger(); // Initialize the logger
    }

    // Function 1 : Process all CSV Files 
    public int[] ProcessAllCSV() throws InventoryException  // Changed return type
    {
        ...
        for (File csvFile : csvFiles) 
        {
            ...
            try {
                ...
                conn.commit();
                success = true;
                processedCount++; // Increment success count
        ...
        return new int[]{totalFiles, processedCount};
    }
}
